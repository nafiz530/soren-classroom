        ...
        >
          <Card className="shadow-2xl">
            <CardHeader className="pb-3">
              ...
              <p className="text-sm whitespace-pre-wrap mt-2">{getQuestionText()}</p>
            </CardHeader>
            <CardContent className="space-y-2">
              {quiz.choices.map((choice) => {
                ...
                return (
                  ...
                  >
                    ...
                    <span className="text-sm">{getChoiceText(choice)}</span>
              ...
              <div className="pt-3">
                {!showResult ? (
                  <Button
                    className="w-full bg-gradient-to-r from-amber-500 to-rose-500"
